        ...
        with app_layout(page_title="Audit History & Logs", subtitle="Immutable System Event Chronicle", current_path="/history"):
            ...
            with ui.card().classes("sw-card p-4 w-full mb-6"):
                with ui.row().classes("w-full items-center justify-between gap-3 flex-wrap"):
                    ...
                    ).classes("w-72 bg-white").props("outlined dense clearable")
                    ...
                    with ui.row().classes("items-center gap-3"):
                        ...
                        ).classes("w-36 bg-white").props("outlined dense")
            ...
            table_container = ui.card().classes("sw-card p-0 w-full overflow-hidden mb-6")
            pagination_row = ui.row().classes("w-full items-center justify-between py-3 px-4 bg-white border-t border-[#E5E7EB]")
